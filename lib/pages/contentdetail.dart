    ...
    return Consumer<ContentDetailProvider>(
      ...
      return Row(
        ...
        children: [
          ...
          }, "ic_pausebtn.png", 25, colorPrimary, colorAccent),
          const SizedBox(width: 40),
          buttonItem(() async {
            if (Constant.userID == null) {
              Navigator.push(
              ...
              Column(
                ...
                children: [
                  ...
                  if (widget.contentType == "5")
                    Utils.moreFunctionItem("ic_share.png", "share", () async {
                      print(widget.contentId);
                      Navigator.pop(context);
                      final shareUrl =
                          "Hey! I'm watching ${widget.contentName} on ${Constant.appName}! 🎬\n"
                          "Watch here 👉 https://Fanbae.tv/music?m=${widget.contentId}\n";
                      print(widget.contentId);
                      print(shareUrl);
          ...
          child: Wrap(
            children: [
              Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Utils.moreFunctionItem("ic_watchlater.png", "watchlater",
                      () async {
                    await contentDetailProvider.addremoveWatchLater(
                        widget.contentType, widget.contentId, "0", "1");
                    if (!context.mounted) return;
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: MyText(
                          color: contentDetailProvider.reportPosition ==
                                      index &&
                                  contentDetailProvider.isSelectReason == true
                              ? colorAccent
                              : white,
            ...
            return InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    MyText(
                        color: contentDetailProvider.playlistPosition ==
                                    index &&
                                contentDetailProvider.isSelectPlaylist == true
                            ? colorAccent
                            : white,
